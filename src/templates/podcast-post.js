    ...
    <Layout>
      ...
      <article className="pa3 podcastPost">
        ...
        <div className="channels">
          ...
          <a rel="noopener noreferrer" target="_blank" class="no-underline near-white bg-animate bg-green hover-bg-light-green inline-flex items-center ma2 tc br2 pa2" href="https://open.spotify.com/show/3bKCmhqOyBadoYW3DmyNEF" title="Spotify">
